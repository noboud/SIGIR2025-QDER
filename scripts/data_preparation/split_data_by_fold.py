#!/usr/bin/env python3
"""
Split data by fold for k-fold cross-validation.
Divides training/test data according to predefined folds.
"""
...
def get_queries(fold_number: str, data: Dict[str, Dict[str, List[str]]], train: bool) -> List[str]:
    """Get training or testing queries for a specific fold."""
...
def create_fold_data(
    ...
    """Create fold-specific data files."""
