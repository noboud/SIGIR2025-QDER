#!/usr/bin/env python3
"""
Split queries into k-folds for cross-validation.
Creates balanced folds for evaluation.
"""
...
def read_queries(file: str):
    """Read queries from TSV file and return list of query IDs."""
    with open(file, 'r') as f:
        return [line.strip().split('\t')[0] for line in f]


def split_queries(queries, k):
    """Split queries into k folds using stratified sampling."""
